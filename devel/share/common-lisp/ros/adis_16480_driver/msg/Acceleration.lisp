...
(cl:defmethod cl:initialize-instance :after ((m <Acceleration>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Acceleration)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name adis_16480_driver-msg:<Acceleration> is deprecated: use adis_16480_driver-msg:Acceleration instead.")))

(cl:ensure-generic-function 'linear_x-val :lambda-list '(m))
(cl:defmethod linear_x-val ((m <Acceleration>))
...
(cl:defmethod linear_y-val ((m <Acceleration>))
...
(cl:defmethod linear_z-val ((m <Acceleration>))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Acceleration>)))
  ...
  "adis_16480_driver/Acceleration")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Acceleration)))
  "Returns string type for a message object of type 'Acceleration"
  "adis_16480_driver/Acceleration")
